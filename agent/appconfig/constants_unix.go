...
var DefaultDocumentWorker = "/opt/bin/ssm-document-worker"
var DefaultSessionWorker = "/opt/bin/ssm-session-worker"
var DefaultSessionLogger = "/opt/bin/ssm-session-logger"
